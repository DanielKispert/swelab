...
public class GUI extends JFrame{
	...
	private final WürfelHandler handler;
	
	private final JButton würfel;
	
	public GUI(Spielfeld spielfeld) {
		this.spielfeld = spielfeld;
		this.handler = new WürfelHandler();
		...
		//add würfel
		würfel = new JButton();
		würfel.addActionListener(handler);
		würfel.setText("würfeln");
		add(würfel);
	}
	
	private class WürfelHandler implements ActionListener {

		@Override
		public void actionPerformed(ActionEvent event) {
			GUI.this.spielfeld.würfle();
		}
